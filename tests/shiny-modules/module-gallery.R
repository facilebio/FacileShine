...
# datadir <- "/data/TenvieHumanDataset/"
# datadir <- "/data/TenvieMouseDataset/"
default_dataset_dir <- "/data/TenvieMouseDataset/"
datasets_dir <- dirname(sub("/+$", "", default_dataset_dir))
debug <- TRUE
...
# afds <- FacileData::FacileDataSet(
#   "~/workspace/projects/revir/data/faciledata/FacileVWMXtalpiDataSet"
# )
# afds <- FacileData::FacileDataSet(datadir)
afds <- FacileData::FacileDataSet(default_dataset_dir)
...
s2 <- dplyr::filter(asamples, treatment == "vehicle")
# s2 <- asamples
